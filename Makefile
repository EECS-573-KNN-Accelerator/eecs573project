...
TCL_SCRIPT = synth/BitNNsynth.tcl
...
build/bitnn.simv: $(BITNN_HEADERS) $(BITNN_SOURCES) $(BITNN_TESTBENCH)
synth/bitnn.vg: $(BITNN_HEADERS) $(BITNN_SOURCES)
build/bitnn.syn.simv: $(BITNN_TESTBENCH)
# Don't need coverage for the CPU

# Connect the simv and syn_simv targets for the autograder
simv: build/bitnn.simv ;
syn_simv: build/bitnn.syn.simv ;
